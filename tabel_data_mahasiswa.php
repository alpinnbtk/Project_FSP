        ...
        if ($res->num_rows > 0) {
            ...
            while($row = $res->fetch_assoc()) {
                echo "<tr>";
                    ...
                    echo "<td><a href='hapus_data_mahasiswa.php?nrp=".$row['nrp']."&ext=".$row['foto_extention']."' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\">Hapus Data</a></td>";
                echo "</tr>";
            }
            echo "</table><br>" ;
